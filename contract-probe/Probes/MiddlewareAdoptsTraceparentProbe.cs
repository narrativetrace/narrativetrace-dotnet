...
/// <summary>
/// <c>probed-default</c>, since 0.1.5: <c>NarrativeTraceMiddleware</c> adopts an inbound
...
/// </summary>
/// <remarks>
/// No reflection needed, unlike the config-seeded probe: the BEHAVIOR is new in 0.1.5, but every
