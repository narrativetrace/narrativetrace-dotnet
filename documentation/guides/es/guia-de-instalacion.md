<!-- source: documentation/guides/installation.md blob 4be3d2bd2a0e | translated: 2026-08-30 | reviewed: 2026-09-03 -->
...
> Las versiones son pre-1.0 (`0.1.0`). Usa la versión que realmente
