<!-- source: documentation/guides/installation.md blob 4be3d2bd2a0e | translated: 2026-09-03 | reviewed: 2026-09-03 -->
...
> As versões são pré-1.0 (`0.1.0`). Use a versão que você realmente
