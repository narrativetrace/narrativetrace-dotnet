...
/// <see cref="MinecraftExampleTests"/> deliberately bypasses by constructing a
...
/// broken entry point is caught here rather than only when a user runs the
/// published example.
/// </summary>
public sealed class ProgramTests
{
    ...
    {
        var programType = typeof(MinecraftExample).Assembly.GetType("Program", throwOnError: true)!;
